...
enum class BackgroundDecoration { NONE, MEDICAL, CATS }
...
class AppearancePreferences(context: Context) {
    ...
    fun setBackgroundDecoration(decoration: BackgroundDecoration) =
    ...
    companion object {
        ...
        private fun read(preferences: android.content.SharedPreferences) = AppAppearance(
            ...
            backgroundDecoration = preferences.getString(KEY_BACKGROUND_DECORATION, null)
                ?.let { runCatching { BackgroundDecoration.valueOf(it) }.getOrNull() }
...
internal const val DEFAULT_BACKGROUND_INTENSITY: Float = 0.45f
