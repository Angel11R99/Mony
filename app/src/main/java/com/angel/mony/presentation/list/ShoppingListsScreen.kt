    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                com.angel.mony.presentation.components.SecondaryButton("Limpiar", onClear, Modifier.weight(1f))
                com.angel.mony.presentation.components.PrimaryButton("Aplicar", onApply, Modifier.weight(1f))
            }
        }
    }
}
